  ...
  return (
    <div className="flex flex-cols w-full h-72 items-center justify-center">
      <div className='w-1/2 text-center'>
        ...
        <button onClick={() => router.push('/create')} className='cursor-pointer bg-black px-3 py-2 font-medium tracking-widest text-white transition duration-300 ease-in-out hover:bg-opacity-40'>CREATE POST</button>
      </div>
    </div>
  )
}
